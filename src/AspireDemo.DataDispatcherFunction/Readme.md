...
WORKDIR /src
COPY ["AspireDemo.DataDispatcherFunction.csproj", "AspireDemo.DataDispatcherFunction/"]
RUN dotnet restore "AspireDemo.DataDispatcherFunction/AspireDemo.DataDispatcherFunction.csproj"

WORKDIR "/src/AspireDemo.DataDispatcherFunction"
COPY . .
RUN dotnet build "AspireDemo.DataDispatcherFunction.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AspireDemo.DataDispatcherFunction.csproj" \
...
Execute unit tests
```
cd "AspireDemo.DataDispatcherFunction/test/AspireDemo.DataDispatcherFunction.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "AspireDemo.DataDispatcherFunction/src/AspireDemo.DataDispatcherFunction"
